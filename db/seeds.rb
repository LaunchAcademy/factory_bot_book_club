# book_club_one = BookClub.create()
book_club_one = BookClub.create(name: "Launch Weirdos", location: "5th floor patio")

if book_club_one.persisted?
  casi = Member.create(first_name: "Casi", last_name: "Newell", email: "casi@ezCater.com", bio: "smarty smart smart" , favorite_book: "Something russian", leader: true, book_club_id: book_club_one.id )
  zach = Member.create(first_name: "Zach", last_name: "Martin", email: "zach@ezCater.com", bio: "very sophisticated", favorite_book: "Game of Thrones", leader: false, book_club_id: book_club_one.id)
